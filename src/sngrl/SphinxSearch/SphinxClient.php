...
/// known grouping functions
    ...
    {
        assert($ranker == self::SPH_RANK_PROXIMITY_BM25
            || $ranker == self::SPH_RANK_BM25
            || $ranker == self::SPH_RANK_NONE
            || $ranker == self::SPH_RANK_WORDCOUNT
            || $ranker == self::SPH_RANK_PROXIMITY);
        $this->_ranker = $ranker;
    }
